...
for WORKLOAD_NAME in ReadStream ReadStreamSinglePk
do
    dotnet run -c Release  -- -n 100000 -w Insert --pl $PL --tcp 10 -e $ACCOUNT_ENDPOINT -k $ACCOUNT_KEY --disablecoresdklogging --database testdb --container testcol -t 10000 --partitionkeypath /pk
